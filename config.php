...
if (empty($rates)) {
    $rates = [
        'F001' => 154.00, 'F002' => 110.00, 'F003' => 119.00,
        'span_price' => 24.00, 'conduit_per_ft' => 0.55,
        'jack_1st_add' => 37.00, 'jack_next_add' => 19.00,
        'copper_remove' => 19.50, 'extra_pd' => 50.00, 'per_diem' => 125.00
    ];
}
