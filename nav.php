...
// --- ROBUST ADMIN CHECK ---
// Matches logic in index.php and tools.php
...
<style>
    ...
    /* GLOBAL RESET */
    body { font-family: 'Inter', sans-serif; margin: 0; padding-top: var(--nav-height); }
    ...
    .icon-btn:hover { background: var(--primary-light); color: var(--primary-accent); }
    ...
    .search-cancel-btn:hover { color: var(--text-primary); }
    ...
    .menu-toggle:hover { background: var(--nav-border); }
    ...
    .nav-open .side-drawer { transform: translateX(0); }
    ...
    .drawer-close { background:none; border:none; cursor:pointer; color:var(--text-secondary); padding:5px; }

    .drawer-content { overflow-y: auto; flex: 1; padding: 0 10px; }
    ...
    .drawer-link svg { width: 20px; height: 20px; stroke-width: 1.75; }

    .drawer-link:hover { background: var(--nav-border); color: var(--text-primary); }
    .drawer-link.active { background: var(--primary-light); color: var(--primary-accent); font-weight: 600; }
...
<nav class="navbar">
    <div style="display:flex; align-items:center;">
        ...
        <a href="index.php" class="nav-brand">
            <svg class="brand-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path></svg>
    ...
    <div class="nav-actions">
        ...
        <button class="icon-btn" onclick="toggleTheme()" title="Theme">
            ...
            <svg id="theme-icon-moon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
        </button>
...
<div id="global-search-container" class="global-search-container">
    <form action="tools.php" method="get" class="search-inner">
        <input type="text" name="q" class="search-input" placeholder="Search ticket, name, address..." autocomplete="off">
...
<div class="side-drawer">
    ...
    <div class="drawer-content">
        ...
        <a href="import_fuel.php" class="drawer-link <?= ($current_page == 'import_fuel.php') ? 'active' : ''; ?>">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18"></path><path d="M5 21V7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v14"></path><path d="M9 10a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2"></path></svg>
            Import Fuel
        </a>
        ...
        <a href="settings.php" class="drawer-link <?= ($current_page == 'settings.php') ? 'active' : ''; ?>">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>
            Rates / Settings
        </a>
