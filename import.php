            ...
            if (!isset($indices['install_date']) || !isset($indices['ticket_number'])) {
                ...
                while (($row = fgetcsv($file)) !== false) {
                    try {
                        ...
                        if (empty($raw_date) || empty($ticket))
                            continue;
        ...
        <div class="box" style="text-align:center;">
            ...
            <form method="post" enctype="multipart/form-data" style="margin-top:20px;">
                ...
                <?php if ($_SESSION['role'] === 'admin'): ?>
                    <div style="text-align:left; margin-bottom:15px;">
                        ...
                        <select name="target_user"
                            style="width:100%; padding:10px; border-radius:6px; border:1px solid var(--border); background:var(--bg-input); color:var(--text-main);">
                ...
                <input type="file" name="csv_file" accept=".csv" required
                    style="margin-bottom:20px; padding:10px; border:1px solid var(--border); border-radius:6px; width:100%; box-sizing:border-box;">
                <br>
